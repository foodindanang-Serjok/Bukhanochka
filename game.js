...
const LEVELS = [
  {
    num: 1, name: 'Уровень 1 — Дорога', emoji: '🛣️', track: 'apex_drift.mp3',
  ...
  {
    num: 4, name: 'Уровень 4 — Снег', emoji: '❄️', track: 'final_lap_sprint.mp3',
...
// --- Аудио ---
const tracks = {};
['apex_drift.mp3','mirage_velocity.mp3','final_lap_sprint.mp3'].forEach(src => {
