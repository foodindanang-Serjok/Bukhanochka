  ...
  if (invincible === 0) {
    for (const o of obstacles) {
      if (checkCollision(playerX, o)) {
        ...
        updateHUD();
        if (lives <= 0) { state = 'over'; showGameOver(); return; }
        break;
      }
    }
  }
